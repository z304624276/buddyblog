    ...
    <form @submit.prevent="handleSubmit" class="post-form">
      ...
      <div class="form-group">
        ...
        <div class="file-upload">
          <div v-if="form.cover" class="file-preview">
            <img :src="previewCover" :alt="form.cover.name" />
      ...
      <div class="form-group">
        ...
        <div class="file-upload">
          <div v-if="form.attachments && form.attachments.length > 0" class="attachments-list">
          ...
          <label v-else for="attachments-input" class="file-label">
            <Upload :size="32" />
...
import { fetchTags, createPost } from '@/api/posts'
import { useAuthStore } from '@/stores/auth'
import { slugifyWithPinyin, ensureSlug, estimateReadingMinutes } from '@/lib/utils'
import TagPill from '@/components/TagPill.vue'
import { X, Upload, Bold, Italic, Heading, Pilcrow, List, ListOrdered, Quote, Code, Eye } from 'lucide-vue-next'
...
const generateSlug = () => {
  form.value.slug = slugifyWithPinyin(form.value.title)
}

const ensureSlugFormat = () => {
  form.value.slug = ensureSlug(form.value.slug)
}
